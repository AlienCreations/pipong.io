...
var publicAudioDest  = function() {
  return publicDest('assets/audio');
};
...
var copyAllAudioToPublicDirectory = function() {
  return gulp.src('./client/assets/audio/**/*')
    .pipe(publicAudioDest());
};
...
gulp.task('audio', copyAllAudioToPublicDirectory);
