...
describe('createPlayer', function() {
  ...
  it('throws an error when username is missing', function() {
    expect(function() {
      createPlayer(fullPlayerDataSwapIn('username', undefined));
    }).toThrow(commonMocks.missingParamErr('username'));
  });
  ...
  it('throws an error when password is missing', function() {
    expect(function() {
      createPlayer(fullPlayerDataSwapIn('password', undefined));
    }).toThrow(commonMocks.missingParamErr('password'));
  });
